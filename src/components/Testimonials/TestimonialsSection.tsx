...
const testimonials: Testimonial[] = [
  {
    id: 1,
    content: "Working with this developer was an absolute pleasure. Their attention to detail and animation expertise brought our project to life in ways we couldn't have imagined.",
    name: "Alexandra Chen",
  ...
  {
    id: 2,
    content: "The UI/UX solutions provided were not only visually stunning but also incredibly functional. The animations added a layer of polish that made our app stand out from competitors.",
    name: "Marcus Johnson",
    position: "CTO",
  ...
  {
    id: 3,
    content: "I was impressed by how seamlessly the animations enhanced the user experience without compromising performance. The attention to micro-interactions made all the difference.",
  ...
  {
    id: 4,
    content: "Exceptional work ethic and technical skill. The developer consistently delivered beyond expectations and was able to translate our vision into beautiful, functional interfaces.",
    name: "Raj Patel",
    position: "Founder",
...
const TestimonialsSection = () => {
  return (
    <section id="testimonials" className="py-24 bg-portfolio-dark relative overflow-hidden">
